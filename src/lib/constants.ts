export const CONTACT = {
  phone: "306-205-4185",
  email: "info@doumar.ca",
  address: "177 Sunset Drive",
  city: "Regina",
  province: "SK",
  postal: "S4S 6Y7",
  fullAddress: "177 Sunset Drive, Regina, SK. S4S 6Y7",
  markPhone: "(306) 539-6815",
  markEmail: "mark@doumar.ca",
};

export const SERVICES = {
  computerizedReturns: {
    title: "Computerized Returns",
    body: "Dou-Mar Services uses the latest in computer and software technology. This ensures that we are able to consider all aspects of your tax situation and find you all of the available deductions and credits. It also gives us the ability to Efile your return so that you can get your refund as soon as possible.",
  },
  efileService: {
    title: "Efile Service",
    body: 'This Revenue Canada, Taxation program allows us to file personal income tax returns by \u201celectronic mail\u201d. It is available from about February 24 until January 31st of the following year. Returns are filed directly to Revenue Canada.',
  },
  competitiveRates: {
    title: "Competitive Rates",
    bullets: [
      "Basic Income Tax prepared for $112.61",
      "Efiling directly to Revenue Canada is included in price",
    ],
  },
  experience: {
    title: "Experience",
    body: "Dou-Mar Services has been providing the highest quality, personal income tax preparation service to Saskatchewan residents since 1989. We also prepare returns for clients from Manitoba, Alberta, & British Columbia. We have already successfully prepared literally thousands of personal income tax returns. The chances are we have already encountered income tax situations quite similar to yours.",
  },
  guaranteedService: {
    title: "Guaranteed Service",
    body: "Dou-Mar Services guarantees all of the services provided by its staff. If we make a mistake we will correct it without any additional cost to you. If you have incurred penalties,and/or interest, because of our mistake we will pay them for you but NOT for the actual tax payable.",
  },
};

export const PRICING = {
  intro: "Dou-Mar Services prices are as follows:",
  baseService: "Individual Return",
  basePrice: "$112.61",
  basePriceNote: "each",
  additionalLabel: "Additional charges for",
  additionalServices: [
    "Business forms",
    "Rental Income form",
    "Employment Expenses",
...
export const PRIVACY_POLICIES = [
  {
    title: "Policy 1 \u2013 Collecting Personal Information",
    clauses: [
  ...
  {
    title: "Policy 3 \u2013 Using and Disclosing Personal Information",
    clauses: [
  ...
  {
    title: "Policy 4 \u2013 Retaining Personal Information",
    clauses: [
  ...
  {
    title: "Policy 5 \u2013 Ensuring Accuracy of Personal Information",
    clauses: [
  ...
  {
    title: "Policy 6 \u2013 Securing Personal Information",
    clauses: [
  ...
  {
    title: "Policy 7 \u2013 Providing Client and Customer Access to Personal Information",
    clauses: [
  ...
  {
    title: "Policy 8 \u2013 Questions and Complaints: The Role of the Privacy Officer or designated individual",
    clauses: [
